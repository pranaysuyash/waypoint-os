...
RAW_FIXTURES = {
    ...
    "business_shortlist": {
        ...
        "structured_input": {
            ...
            "resolved_destination": ["Grand Hyatt Goa", "Taj Fort Aguada"],
        },
        "expected": {
            "extracted_fields": {
                "origin_city": {"value": "Bangalore", "authority": "explicit_owner"},
    ...
    "vague_lead": {
        ...
        "expected": {
            "extracted_fields": {
                "party_composition": {"value": "big family (unknown count)", "authority": "explicit_owner"},
                "date_window": {"value": "maybe March", "authority": "explicit_owner"},
            },
            "expected_unknowns": [
                "origin_city",
            ...
            "nb02_hard_blockers": ["origin_city", "destination_candidates", "party_size"],
    ...
    "whatsapp_dump": {
        ...
        "expected": {
            "extracted_fields": {
                ...
                "soft_preferences": {"value": "beaches, nothing too adventurous, young kids", "authority": "explicit_owner"},
    ...
    "partial_crm_entry": {
        ...
        "structured_input": {
            ...
            "date_window": "2026-03-15 to 2026-03-20",
            "party_size": 4,  # Old value — contradicts new note
            "budget_min": "300000",
        },
        "expected": {
            "extracted_fields": {
    ...
    "confused_couple": {
        ...
        "expected": {
            "extracted_fields": {
                ...
                "destination_candidates": {"value": "Singapore/Thailand", "authority": "explicit_owner"},
                "date_window": {"value": "March 15-20 OR April 1-6", "authority": "explicit_owner"},
                "party_size": {"value": "2 or 3", "authority": "explicit_owner"},
                "budget_min": {"value": "120000 or 200000", "authority": "explicit_owner"},
            },
    ...
    "crm_update_new_call": {
        ...
        "expected": {
            "extracted_fields": {
                "origin_city": {"value": "Bangalore", "authority": "imported_structured"},
                "party_size": {"value": 4, "authority": "imported_structured"},
                "budget_min": {"value": "flexible", "authority": "explicit_owner"},
            ...
            "expected_contradictions": [],
            "nb02_decision_state": "ASK_FOLLOWUP",
            "nb02_hard_blockers": ["destination_candidates", "date_window"],
    ...
    "dreamer_budget_vs_luxury": {
        ...
        "expected": {
            "extracted_fields": {
                "origin_city": {"value": "Bangalore", "authority": "explicit_owner"},
                "destination_candidates": {"value": "Maldives", "authority": "explicit_owner"},
                "party_size": {"value": 4, "authority": "explicit_owner"},
                "budget_min": {"value": "150000", "authority": "explicit_owner"},
                "soft_preferences": {"value": "5-star resort, 7 nights", "authority": "explicit_owner"},
            },
            "expected_unknowns": ["date_window"],
            "expected_contradictions": ["budget_conflict"],  # Budget vs hotel tier
            "nb02_decision_state": "ASK_FOLLOWUP",
            "nb02_hard_blockers": ["date_window"],
    ...
    "revision_loop_budget_impossible": {
        ...
        "structured_input": {
            ...
            "date_window": "2026-04-01 to 2026-04-07",
            "party_size": 6,
            "budget_min": "300000",
        },
        "expected": {
            "extracted_fields": {
                "origin_city": {"value": "Bangalore", "authority": "imported_structured"},
                "destination_candidates": {"value": "Maldives", "authority": "imported_structured"},
                "date_window": {"value": "2026-04-01 to 2026-04-07", "authority": "imported_structured"},
                "party_size": {"value": 6, "authority": "imported_structured"},
                "budget_min": {"value": "300000", "authority": "imported_structured"},
            },
            "expected_unknowns": [],
