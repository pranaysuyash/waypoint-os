 ...
 * request to the spine_api backend, ensuring sessions are maintained
...
/**
 * Build headers that forward the incoming request's cookies to spine_api.
...
/**
 * Construct the spine_api base URL.
 */
