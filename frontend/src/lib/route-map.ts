...
const BACKEND_ROUTE_ENTRIES: Array<[string, BackendRouteConfig]> = [
  ...
  ["public-checker/matches", { backendPath: "api/public-checker/matches" }],
  ["public-checker/route-request", { backendPath: "api/public-checker/route-request" }],
  ["public-checker/re-verify", { backendPath: "api/public-checker/re-verify" }],
  ["public-checker/trip/{id}", { backendPath: "api/public-checker/trip/{id}" }],
  ["public-checker/trip/{id}/export", { backendPath: "api/public-checker/trip/{id}/export" }],
  ["public-checker/disputes", { backendPath: "api/public-checker/disputes" }],
