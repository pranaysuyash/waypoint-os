          ...
          <div className='space-y-3'>
            ...
            <label className='flex items-center justify-between cursor-pointer group'>
              <div className='flex items-center gap-2'>
                ...
                <div>
                  <p className='text-ui-sm text-[#e6edf3]'>Ghost Concierge</p>
                  <p className='text-ui-xs text-[#8b949e]'>
            ...
            <label className='flex items-center justify-between cursor-pointer group'>
              <div className='flex items-center gap-2'>
                ...
                <div>
                  <p className='text-ui-sm text-[#e6edf3]'>Sentiment Detection</p>
                  <p className='text-ui-xs text-[#8b949e]'>
            ...
            <label className='flex items-center justify-between cursor-pointer group'>
              <div className='flex items-center gap-2'>
                ...
                <div>
                  <p className='text-ui-sm text-[#e6edf3]'>Federated Intelligence</p>
                  <p className='text-ui-xs text-[#8b949e]'>
            ...
            <label className='flex items-center justify-between cursor-pointer group'>
              <div className='flex items-center gap-2'>
                ...
                <div>
                  <p className='text-ui-sm text-[#e6edf3]'>Auto-Negotiation</p>
                  <p className='text-ui-xs text-[#8b949e]'>
            ...
            <div className='pt-2 space-y-2'>
              <div className='flex justify-between items-center'>
                <p className='text-ui-xs text-[#e6edf3] flex items-center gap-1'>
                  <ShieldCheck className='w-3 h-3 text-accent-green' />
                  Negotiation Margin
                </p>
                <span className='text-[var(--ui-text-xs)] font-mono text-accent-green'>
              ...
              />
              <p className='text-[var(--ui-text-xs)] text-[#8b949e]'>
            ...
            <div className='pt-2 space-y-2'>
              <div className='flex justify-between items-center'>
                ...
                <span className='text-[var(--ui-text-xs)] font-mono text-[#58a6ff]'>
