...
import type { IntegrityAction, IntegrityIssue } from '@/types/spine';
...
export default function IntegrityMonitorPanel({
  ...
  return (
    <>
      ...
      />
      <aside
        className='fixed right-0 top-0 bottom-0 w-96 bg-[#0f1115] border-l border-[#30363d] z-50 overflow-y-auto'
        role='dialog'
      ...
      >
        <div className='flex items-center justify-between p-4 border-b border-[#30363d]'>
          <div className='flex items-center gap-2'>
            ...
            <h2 className='text-ui-sm font-semibold text-[#e6edf3]'>
              System Check
            </h2>
          </div>
          <button
