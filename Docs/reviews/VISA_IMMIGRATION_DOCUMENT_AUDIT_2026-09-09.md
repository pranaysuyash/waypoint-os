...
| ID | Item | Artifact |
|---|---|---|
| VE-01 | Visa data-source landscape (Sherpa/Timatic/iVisa/gov portals) | `Docs/exploration/VISA_DATA_SOURCE_LANDSCAPE_2026-09-09.md` (web-researched) |
...
| Check | Result |
|---|---|
| Unit: radar (incl. VA-01/03 additions) | 8/8 pass |
| New seed/regression tests (`tests/test_visa_scenario_seeds.py`) | 17/17 pass (fixtures + VA-06 forms + rule ladder) |
| Extraction-touching test files | 636/636 pass |
| Eval-lane / drift tests | 660/660 pass |
| Constraint tests (post VA-05) | 53/53 pass |
| Full suite (excluding 2 parallel-owned failure files) | **4,161 passed, 44 skipped, 0 failed** |
| Ruff on changed files | clean (see handoff) |
...
## 6. Files touched (this audit's execution pass)
